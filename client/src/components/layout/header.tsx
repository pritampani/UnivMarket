...
import { Search, Menu, Plus, X, HelpCircle } from "lucide-react";
        ...
        <div className="flex justify-between h-16 items-center">
          ...
          <nav className="hidden md:flex items-center space-x-4">
            ...
            <Button 
              ...
              title="Take a tour of UniMarket"
            >
            ...
            {user ? (
              <>
                ...
                <div className="pt-2 border-t border-gray-200 space-y-2">
                  <Button variant="outline" onClick={startOnboarding} className="w-full flex items-center justify-center">
                    <HelpCircle className="h-4 w-4 mr-1" /> Take a Tour
                  </Button>
              ...
              <div className="flex flex-col space-y-2 pt-2 border-t border-gray-200">
                ...
                <Button variant="outline" onClick={openSignupModal}>Sign Up</Button>
                <Button variant="ghost" onClick={startOnboarding} className="flex items-center justify-center mt-2">
                  <HelpCircle className="h-4 w-4 mr-1" /> Take a Tour
                </Button>
              </div>
            )}
